...
export interface StakesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getStakeAmount"
      | "getStakedNftId"
...
export interface Stakes extends BaseContract {
  connect(runner?: ContractRunner | null): Stakes;
  waitForDeployment(): Promise<this>;

  interface: StakesInterface;
